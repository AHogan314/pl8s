...
<html>
	...
	<form action="db-simple.php" method="post" />
		<fieldset>
			<input type="hidden" name="formID" value="form1">
					...
					<div class="form-group">
						...
						<div class="checkbox">
					    	<label for="checkboxes-2">
					      		<input type="checkbox" name="signal" id="checkboxes-1" value="1">No turn signal
					    	</label>
						</div>
						<div class="checkbox">
					    	<label for="checkboxes-3">
					      		<input type="checkbox" name="distracted" id="checkboxes-1" value="1">Distracted Driving 
					    	</label>
						</div>
					</div>
				</div>
				...
				<div class="form-group text-center">
			  		...
			  		<div class="col-md-4">
			    		<button id="singlebutton" name="submit" class="btn btn-primary" value="search">Search</button>
			    		<button id="singlebutton" name="submit" class="btn btn-primary" value="submit">Submit</button>
			  		</div>
				</div>
			</fieldset>
		</form>
...
<!--search form-->
	...
	<form action="db-simple-search.php" method="post" />
		<fieldset>
			<input type="hidden" name="formID" value="form1">
				<!-- State Select -->
				<label class="col-md-4 control-label" for="selectbasic">State</label>
