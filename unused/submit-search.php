...
?>
			...
			<div class="row">
				<div class="span12 text-center">
					<p>
						<a href="#" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-search"></span> Search</a>
						<a href="#" class="btn btn-lg btn-default"><span class="glyphicon glyphicon-pencil"></span> Submit</a>
					</p>
				</div>
			</div>
